...
/** Appendix D — service response code metadata + decline taxonomy. */
...
/** Appendix F — CVV codes. `classification` is derived, not from the spec. */
...
export const SPEC_API_VERSION = "4.14";
